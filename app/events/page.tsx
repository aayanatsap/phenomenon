...
const cardsData = [
  ...
  { 
    ...
    rules: [
      "Team Event (3 members per team)",  
      "This event is open to students from grades 8th to 1st Year Degree",  
      "Each team will be required to carry atleast one laptop. NO Internet connection will be provided",  
  ...
  { 
    ...
    rules: [
      ...
      "Participants will be required to carry their own devices(with data as it will not be provided)",  
  ...
  { 
    ...
    content: "This will be a gastronomer's delight. Join us on this culinary journey and let your inner Ramsey shine. The participants will have to identify the ingredients in a dish by tasting it.",
    rules: [
      "Individual event",  
      "This event is open to students from grades 8th to 1st Year Degree",  
  ...
  { 
    ...
    rules: [
      "Team Event (5-7 members per team)",  
      "This event is open to students from grades 8th to 1st Year Degree",  
  ...
  },
  {
    ...
    rules : [
      "Team Event (10-12 members per team)",  
      "This event is open to students from grades 8th to 1st Year Degree",  
      "Timings: 5+2 minutes",  
      "Open registrations may be permitted if the cap for the number of teams is not met. (The team members may be drawn from different schools and colleges)",  
      "If all the team members are from one particular school or college, then only one team will be permitted in such a situation",  
      "The theme is ‘The Arctic Runway’. Participants will be assigned a particular movie or a TV show upon registration, and must dress up according to the theme/set of the given movie/ TV show",  
  ...
  },
  {
    ...
    rules : [
      "Team Event (4 members per team; inclusive of 1 substitute)",  
      ...
      <div className="lg:mb-24 md:mb-44 mb-52 px-3">
        ...
        {cardsData.map((card, idx) => (
          <EventsCard
            ...
            rules={card.rules}
            banner={card.banner}
            key={idx} // Correctly set key for React
          />
        ))}
      </div>
    </div>
