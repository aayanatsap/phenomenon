...
function Rules() {
  const generalRules = [
    "The dress code must be strictly followed. Shorts/skirts/sleeveless/ ripped jeans clothing is prohibited.",
    ...
    "Illegal and restricted items such as alcohol, tobacco, condoms, marijuana, or any type of drug, etc. are strictly prohibited and legal action will be taken.",
    "Public display of affection, of any kind, is strictly prohibited.",
    "All attendees, event staff, and volunteers must be respected.",
    ...
    "Any sort of weaponry or sharp and harmful objects are prohibited (eg Nail cutters, comb, Swiss army knives, scissors, knives, box cutters, blades, pens, pencils, etc.)",
    "Toy replicas of guns or objects to throw/shoot are not allowed.",
  ...
  const eventRules = [
    ...
    "Every institution is requested to confirm your participation as early as possible by sending us an e-mail. Contact information is given behind this invite. The final list of participants must be submitted at the time of registration on the day of the fest.",
  ...
  return (
    <div className='flex flex-col w-screen items-center gap-16 mb-52 md:px-10 px-2 font-semibold'>
      ...
      <div className='w-screen lg:px-36 px-5 text-center md:px-24'>
