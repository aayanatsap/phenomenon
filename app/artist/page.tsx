...
function Artist() {
  return (
    <AnimatePresence>
      ...
      className="flex flex-col items-center justify-center h-[100vh] text-[#0BB3BA] font-aquireBold">
        <div className="flex flex-col items-center lg:-translate-y-16 md:-translate-y-20 -translate-y-28">
          <h1 className="lg:text-4xl md:text-3xl text-2xl font-bold mb-4">COMING SOON</h1>
