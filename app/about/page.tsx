...
function About() {
  return (
    <div className='text-electricBlue lg:text-2xl md:text-xl lg:px-44 text-center flex flex-col lg:gap-10 mb-52 gap-6 text-lg px-7 md:px-16 md:gap-8  font-trench font-bold'>
      ...
      <p>
        Phenomenon opens the gates to the world of creativity and imagination. It showcases extraordinary talents and gives the students a dynamic platform where culture meets creativity, offering a rich tapestry of performances. At its core, Phenomenon is about community and connection. It allows participants and audiences to experience the beauty of cultural diversity, fostering understanding and appreciation for traditions both familiar and new. It’s a space where passion, talent, and tradition converge, leaving everyone inspired and enriched.
      </p>
      <p>
