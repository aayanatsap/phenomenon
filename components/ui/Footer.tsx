...
export function Footer() {
  ...
  return (
    <div
      ...
      } grid md:grid-flow-col grid-flow-row md:gap-0 gap-2 md:py-0 py-2.5 items-center md:pr-0 md:pl-0 lg:px-12 md:px-8 pr-2 pl-1 lg:h-[120px] md:h-[100px] text-electricBlue bg-galaxyBlue bg-opacity-70 w-screen border-t-2 border-electricBlue border-opacity-70`}
    >
        ...
        <div className="grid md:grid-flow-col grid-flow-row items-center w-full">
          <div className="flex flex-row items-center">
            ...
            <div className="grid grid-flow-row gap-2">
              <span className="text-xs text-aquaBlue">© 2024 St <a href="www.sjbhs.edu.in" className="hover:underline">Joseph's Boys' High School</a>. All Rights Reserved.</span>
